...
np.save(f'./save/in_couple_tm_fine_short', tm)
np.save(f'./save/in_couple_te_fine_short', te)
np.save(f'./save/in_couple_tm2_fine_short', tm2)
np.save(f'./save/in_couple_te2_fine_short', te2)
...
plt.legend()
plt.tight_layout()
plt.savefig('./result/in_coupling_fine_TM_short.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('./result/in_coupling_fine_TE_short.png')
plt.show()
