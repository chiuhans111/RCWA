...
AOIs = np.linspace(29.49, 60.6, 61)
tick = time.time()
tm = []
te = []
tm2 = []
...
np.save(f'./save/out_couple_tm_fine', tm)
np.save(f'./save/out_couple_te_fine', te)
np.save(f'./save/out_couple_tm2_fine', tm2)
np.save(f'./save/out_couple_te2_fine', te2)

# tm = np.load(f'./save/out_couple_tm_fine.npy')
# te = np.load(f'./save/out_couple_te_fine.npy')
# tm2 = np.load(f'./save/out_couple_tm2_fine.npy')
# te2 = np.load(f'./save/out_couple_te2_fine.npy')
...
plt.legend()
plt.tight_layout()
plt.savefig('./result/out_coupling_fine_TM.png')
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig('./result/out_coupling_fine_TE.png')
plt.show()
